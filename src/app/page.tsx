    ...
    <div className="pb-20">
      ...
      <section className="relative h-[80vh] flex items-center justify-center bg-black text-white overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-40">
          {/* Abstract minimalist background or video would go here. Using CSS gradient for now */}
        ...
        <div className="container relative z-10 px-4 text-center space-y-6">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mb-4 font-script">
              Tu idea hecha realidad
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto">
              Diseño exclusivo. Calidad premium. Minimalismo puro.
            </p>
          </motion.div>
          ...
          >
            <Link href="#products">
              <Button size="lg" className="bg-white text-black hover:bg-gray-200 text-lg px-8 rounded-full border-2 border-white">
                Ver Colección
              </Button>
            </Link>
          </motion.div>
      ...
      <section className="py-16 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-3xl font-bold tracking-tight">Más Vendidos</h2>
            <Link href="#products" className="text-primary hover:underline font-medium">Ver todo</Link>
          </div>
      ...
      <section id="products" className="py-16 container mx-auto px-4">
        <h2 className="text-3xl font-bold tracking-tight mb-8 text-center">Nuestra Colección</h2>
